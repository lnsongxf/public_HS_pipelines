global fname pdd_BayArea_xs_1k_ddd
...
use if insample == 1 & random_id < 1.01 using $ddir/generated_data/dd_regdata, clear
    ...
    keep if inlist(mm_fips_county_name,"SAN MATEO","SANTA CLARA","SAN FRANCISCO","ALAMEDA","CONTRA COSTA","MARIN") | inlist(mm_fips_county_name,"LOS ANGELES","ORANGE")
 
capture drop _T* PGE
do $ddir/analysis/pdd_prep_distance_defs_ddd.do
