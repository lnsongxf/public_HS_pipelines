...
# Start logging
LOG_FILENAME = r"{}/output/logs/dq_to_pipelines_nodistr.log".format(buildPath)
...
if __name__ == '__main__':
    ...
    outfile = r"{}/output/CA_assess_to_pipes_nodistr.dta".format(buildPath)
    ng_select = "{}/output/ng_nodistr.shp".format(buildPath)
    ...
    if selections['ng'] != "":
        ...
        # Caluclate distances
        with fiona.open(unified) as sourceline:
            df['km_to_ng_nodistr'] = dq_to_pipes(df,sourceline)/1000.0
        logging.info("km_to_ng_nodistr calculated")
